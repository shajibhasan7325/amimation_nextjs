    ...
    >
      ...
      >
        ...
        <p className="mb-8 text-center text-xs font-light text-text">
          by
          <Link href="https://www.codesandbox.com">CodeSandbox</Link>
          ,
          <br />
          rebuilt by
          <Link href="https://www.frontend.fyi">Frontend.FYI</Link>
        </p>
        ...
        <Link href="#" className="flex items-center text-lg text-primary">
